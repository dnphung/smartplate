...
class StomachIndicatorView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        SmartPlateKit.drawCanvas1(frame: UIScreen.main.bounds, resizing: .aspectFit, fatValue: fatValue, carbsValue: carbsValue, proteinValue: proteinValue, othersValue: othersValue, caloriesTrackingValue: caloriesTrackingValue )
    }
}
